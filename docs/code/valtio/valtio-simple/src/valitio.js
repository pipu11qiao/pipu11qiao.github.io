...
// import { proxyFunction, subscribe } from './exercise/listener/listener2';
// import { proxyFunction, subscribe } from './exercise/listener/listener4';
// import { proxyFunction, subscribe } from './exercise/listener/listener5';

// import { proxyFunction } from './exercise/baseProxy/exercise6';
import { proxyFunction, subscribe } from './exercise/listener/listener6';
const data = {
  count: 0,
  text: 'hello',
  person: {
